      ...
      <div class="modal-body">
                ...
                <!-- input要素やselectボックスでは、取得したデータをvalueで初期値に設定している -->
                    <div class="d-flex flex-column">
                        ...
                        <input type="text" name="class_name" value="{{ old('class_name', $creditedclass->class_name) }}" required>

                        <label>教員名</label>
                        <input type="text" name="teacher_name"  value="{{ old('teacher_name', $creditedclass->teacher_name) }}" >
                        ...
                        <input type="number" name="amount_credit" value="{{ old('amount_credit', $creditedclass->amount_credit) }}" required>
                    </div>
